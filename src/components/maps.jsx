...
import MapAutoComplete from '../components/mapsComponent/mapAutoComplete';
import MapMarker from '../components/mapsComponent/mapMaker';
  ...
  render() {
    ...
    return (
      ...
      <div className="w-100 d-flex py-4 flex-wrap justify-content-center">
        ...
        {/* Maps Section */}
        <section className="col-8 h-lg"  style={{ height: 500  }}>
          <GoogleMapReact
            bootstrapURLKeys={{
              key: 'AIzaSyA-m-1LveX5OMIArOh91Z41a0cjpiqSDek',
          ...
          <div>
            ...
            <section className="col-12">
              <div className="d-flex flex-column justify-content-center">
                <h1 className="mb-4 fw-md">Your Rentals!</h1>
