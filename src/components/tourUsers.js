...
const TOUR_STEPS = [ 
   {
    target: ".tour-user",
    content: "On this page you can view your own personal details and current status.Future updates will enable you to modify the system to your personal feel and style",
    disableBeacon: true
  }, 
  {
    target: ".tour-link",
